...
- It's a custom hook which hooks into react's lifecycle to provide us an update for when the route changes, allowing us to have a constantly accurate reference to the route as controlled by the routing library.

1. How would you explain form validation to someone who has never programmed before?

- It allows you to verify that the correction information is being put into the form, such as valid emails, passwords of an appropriate length, etc.

1. In 1-2 sentences, define end to end testing.

- e2e testing is user to server testing that doesn't worry about coding specifics like unit testing and instead ensures that an process that starts one way results in a predicted end.
